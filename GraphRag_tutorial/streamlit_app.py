...
st.sidebar.info(
    "This app allows you to explore a knowledge graph stored in a Neo4j database and a vector database, querying both using local and global search functions for comparison.")