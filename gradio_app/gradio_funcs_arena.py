...
#
# lightrag = LightRagWrapper(working_dir="./lightrag_docs",
#                            llm_model_name="deepseek-r1:8b",
#                            doc_dir="./data/pdfs")
# chroma_db = Database(chroma_path="chroma",
#                      collection_name="documents")
# ollama = OllamaInterface("deepseek-r1:8b", chroma_db.db)
# document_loader = DocumentLoader(chroma_db,
#                                  collection_name="documents",
#                                  data_path="./data/pdfs")
#
#
...
#
#     return "Files processed: " + str(selected_files)
